...
Then, users may head to the forecast tab, choose one of the locations you provided and click on "Get Weather Please".
After a brief load users will be presented with the current weather in the location they've chosen,
and a forecast for the next 7 days.
